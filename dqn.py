...
class DQNAgent(agents.QlearningAgent):
    def __init__(self, name, money, color, game, gamma=0.9, epsilon=1.0, lr=0.001, input_dims=40, batch_size=30, n_actions = 28, max_memory=100000, eps_min=0.05, eps_step=5e-4, tau=0.005):
